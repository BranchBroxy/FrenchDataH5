...
class TestDDT(unittest.TestCase):
    ...
    def test_DDT(self):
        ...
        self.assertEqual(FM_real.all(), FM_DDT.all())
    ...
    def test_apply_DDT_to_CM(self):
        ...
        FM_real = np.array([[0, 0, 5, 7, 0], [5, 0, 0, 6, 0], [0, 0, 0, 0, 7], [5, 0, 0, 0, 5], [0, 0, 4, 0, 0]], dtype=np.float64)
        ...
        self.assertEqual(FM_real.all(), FM_DDT[0][1].all())
